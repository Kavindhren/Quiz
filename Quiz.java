...
public class Quiz implements ActionListener{
	...
	String[] questions = {
							...
							"_______ is a collection of elements used to store the same type of data.",
							...
							"Each element in a String array is automatically initialized to ______.",
							"Elements in an ArrayList must be ______.",
	...
	String[][] options = {
							...
							{"Heighest", "Least", "Equal", "None of These"},
	...
	int total_questions = 10;		//	The value 10 represent number of questions need to be answer
	int result;
	int seconds=10;
	int num = 0; 
	...
	public Quiz(String userID) {
		...
		// ------------------------------- Below code is for randomize the quiz questions and only select 10 questions
		...
		// ------------------------------- Above Code is for randomize the quiz questions and only select 10 questions
		...
		textfield.setBackground(new Color(107,107,119));
		textfield.setForeground(new Color(255,51,51));
		...
		textarea.setForeground(SystemColor.textHighlightText);
